                    ...
                    <div class="footer-up">
                        <div class="row {{$text}}" dir="{{$dir}}" lang="{{$lang}}">
                            ...
                            <div class="col-lg-4 offset-lg-1 col-md-6 com-sm-12">
                                <h5 class="text-center">{{__('core.F-mainmenu')}}</h5>
                                <div class="row justify-content-center">
                                    <div class="col-5 offset-lg-2">
                                        <ul>
                                            <li>
                                                <a href="{{route('welcome')}}">{{__('core.HOME')}}</a>
                                                <a href="{{route('products')}}">{{__('core.PRODUCTS')}}</a>
                                                <a href="{{request()->routeIs('welcome') ? '#faq' : '/#faq' }}">{{__('core.FAQ')}}</a>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="col-5">
                                        <ul>
                                            <li>
                                                <a href="{{route('enterprise')}}">{{__('core.ENTERPRISE')}}</a>
                                                <a href="{{route('contact')}}">{{__('core.CONTACT-US')}}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 offset-lg-1 col-md-6">
                                <div class="subscribe-form">
                                    <h5>{{__('core.CONTACT-INFO')}}</h5>
                                    <ul class="contact_info">
                                        <li>
                                            <i class="fa fa-map-marker"></i>
                                            <p class="mt-0">{{__('core.location')}}</p>
                                        </li>
                                        <li>
